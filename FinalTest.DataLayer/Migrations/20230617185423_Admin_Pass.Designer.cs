...
namespace FinalTest.DataLayer.Migrations
{
    ...
    [Migration("20230617185423_Admin_Pass")]
            ...
            modelBuilder.Entity("FinalTest.DataLayer.Entity.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOnDate = new DateTimeOffset(new DateTime(2023, 6, 17, 18, 54, 23, 415, DateTimeKind.Unspecified).AddTicks(6342), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "admin1@admin.com",
                            IsAdmin = true,
                            IsDeleted = false,
                            ModifiedOnDate = new DateTimeOffset(new DateTime(2023, 6, 17, 18, 54, 23, 415, DateTimeKind.Unspecified).AddTicks(6538), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Admin1",
                        ...
                        new
                        {
                            Id = 7,
                            ConfirmPassword = "QWRtaW5AMTIzI3NlY3JldEBwYXNzd29yZCExaGFzaGluZ19rZXkk",
                            CreatedOnDate = new DateTimeOffset(new DateTime(2023, 6, 17, 18, 54, 23, 415, DateTimeKind.Unspecified).AddTicks(6765), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "admin2@admin.com",
                            IsAdmin = true,
                            IsDeleted = false,
                            ModifiedOnDate = new DateTimeOffset(new DateTime(2023, 6, 17, 18, 54, 23, 415, DateTimeKind.Unspecified).AddTicks(6775), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Admin2",
                            Password = "QWRtaW5AMTIzI3NlY3JldEBwYXNzd29yZCExaGFzaGluZ19rZXkk",
